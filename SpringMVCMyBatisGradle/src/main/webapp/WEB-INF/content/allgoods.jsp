...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			<div class="carousel slide" id="carousel-571624">
				<ol class="carousel-indicators">
					<li data-slide-to="0" data-target="#carousel-571624">
					</li>
					<li data-slide-to="1" data-target="#carousel-571624" class="active">
					</li>
					<li data-slide-to="2" data-target="#carousel-571624">
					</li>	
					<li data-slide-to="3" data-target="#carousel-571624">
					</li>									
				</ol>
				<div class="carousel-inner">
					<div class="item">
						<img alt="" src="images/allgoods1.jpg" />
					</div>
					<div class="item active">
						<img alt="" src="images/index1.jpg" />
					</div>
					<div class="item">
						<img alt="" src="images/allgoods3.jpg" />
					</div>
					<div class="item">
						<img alt="" src="images/allgoods4.jpg" />
					</div>
				</div> <a class="left carousel-control" href="#carousel-571624" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a> <a class="right carousel-control" href="#carousel-571624" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
			</div>
		</div>
	</div>
</div>
<div class="container">
	...
	<div class="collapse navbar-collapse" id="example-navbar-collapse">
		<ul class="nav navbar-nav">
			...
			<li><a href="sort1">和风轻许，与奈而合</a></li>
			<li><a href="sort2">怦然心动</a></li>
			<li><a href="sort3">情迷莎翁</a></li>
			<li ><a href="sort4">雾是沉睡的海 </a></li>
		</ul>
			...
			<c:forEach items="${requestScope.goods_list }" var="goods">
				<div class="col-md-4">
					<div class="thumbnail">
						<img alt="300x200" class="img-responsive" src="images/${goods.image}" />
						<div class="caption">
							<h3>

...
<title>奈看</title>
<style type="text/css"> 
        .exp{font-size:60px;color:#FF7F50;font-family: fantasy;}
        .opt{font-size:20px;font-family:Arial;}
</style> 
...
<div class="text-center">
        <p class="exp">操作成功！</P>
        <p class="opt"><a href="collect?user_id=${sessionScope.user.id}">查看收藏夹</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="cart?user_id=${sessionScope.user.id}">查看购物车</a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="order?user_id=${sessionScope.user.id}">查看订单</a></p>
</div>
</div>
</body>
</html>
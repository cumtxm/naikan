...
<ol class="breadcrumb">
	<li>
		<div class="btn-group col-sm-12 col-md-12">
	...
	<li><a href="allgoods?user_id=${sessionScope.user.id}">所有商品</a></li>
		<li><a href="sort1">和风轻许，与耐而合</a></li>
		<li><a href="sort2">怦然心动</a></li>
		<li><a href="sort3">情迷莎翁</a></li>
		<li><a href="sort4">雾是沉睡的海</a></li>
...
<div class="col-sm-12 col-md-12">
	<a href="allgoods"><img class="img-responsive" src="images/index1.jpg"></a>
</div>
<div class="col-sm-12 col-md-12">
	<a href="details?goods_id=7"><img class="img-responsive" src="images/index2.jpg"></a>
</div>
<div class="col-sm-12 col-md-12">
	<a href="details?goods_id=8"><img class="img-responsive" src="images/index3.jpg"></a>
</div>
<div class="col-sm-12 col-md-12">
	<a href="details?goods_id=3"><img class="img-responsive" src="images/index4.jpg"></a>
</div>
